...
import { TEnrolledCourse } from "./enroll.interface";
import { OfferedCourse } from "../OfferedCourses/OfferedCourse.model";
import AppError from "../../utils/AppError";
import { studentModel } from "../student/student.model";
import EnrolledCourse from "./enroll.model";
import { semesterRegistrationModel } from "../SemesterRegistration/semester_registration.model";
import { courseModel } from "../Course/course.model";
import { facultyModel } from "../Faculty/faculty.model";
import { calculateGradeAndPoints } from "./enroll.utils";
...
const updateEnrolledCourseMarksIntoDB = async (
  ...
  if (!isCourseBelongToFaculty) {
    throw new AppError(
      ...
      "You are forbidden to update marks!"
    );
  }
